...
return [
    ...
    */
    ...
    | especificar uma mensagem de idioma específica para uma determinada regra de atributo.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de idioma são usadas para substituir nossos marcadores de posição de atributos
